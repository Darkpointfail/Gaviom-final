...
/** Max entries per founding sweepstakes — keep in sync with prize HTML data-live-max */
const POOL_CAPS = {
  msc: 3000,
  diving: 3000,
  vegas: 3000,
...
/** AMOE metadata for founding prizes — keep in sync with app.js PRIZE_AMOE */
const PRIZE_AMOE = {
  msc: { sweepstakesId: 1, rulesSection: 'promotion-1', label: 'Sweepstakes #1' },
  diving: { sweepstakesId: 2, rulesSection: 'promotion-2', label: 'Sweepstakes #2' },
  vegas: { sweepstakesId: 3, rulesSection: 'promotion-3', label: 'Sweepstakes #3' },
  iphone: { sweepstakesId: 4, rulesSection: 'promotion-4', label: 'Sweepstakes #4' },
};
